...
- Basic JavaScript syntax knowledge — see [[JavaScript Essentials]]
...
For unknown encoding types, use a cipher identifier (dcode.fr or boxentriq.com) or paste into [[CyberChef]] and use the Magic recipe to detect the encoding automatically.
