...
category: "tools"
tags: []
excerpt: "Telnet is an insecure plaintext protocol used to establish raw TCP connections to remote hosts and services. While..."
date: "2026-06-20"
---
...
> [!INFO]- Commands:
> `telnet <IP> 25`
> See [Protocols](/knowledge/Networking/Protocols) for SMTP commands (HELO, MAIL FROM, DATA etc.)
...
> [!INFO]- Commands:
> `telnet <IP> 110`
> See [Protocols](/knowledge/Networking/Protocols) for POP3 commands (USER, PASS, LIST, RETR etc.)
