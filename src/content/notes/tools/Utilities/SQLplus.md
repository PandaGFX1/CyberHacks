...
category: "tools"
tags: []
excerpt: "SQLplus (SQLplus) is Oracle's command-line client for connecting to and interacting with Oracle Database instances...."
date: "2026-06-20"
---
...
## Target / Context
Oracle Database instances accessible via TNS listener on TCP/1521. Requires valid credentials (or SYSDBA privileges via an authenticated path from [ODAT](/tools/Enumeration/ODAT)).
...
---
## Related Concepts
- [Oracle TNS](/knowledge/Networking/Oracle-TNS)
