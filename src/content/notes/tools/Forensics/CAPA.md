...
category: "tools"
tags: []
excerpt: "CAPA (Common Analysis Platform for Artifacts) is a tool developed by FireEye Mandiant that identifies capabilities..."
date: "2026-03-28"
---
...
Place <code>capa.exe</code> in working directory or add to PATH
...
<ul class="callout-list">
  <li><code>capa <binary></code></li>
  <li><code>capa.exe .\cryptbot.bin</code></li>
  <li><code>capa cryptbot.bin</code></li>
  <li><code>capa -h</code></li>
</ul>
...
|------|-------------|---------|
| <code>-h</code> | Display help | <code>capa -h</code> |
| <code>-v</code> | Increase verbosity | <code>capa.exe .\cryptbot.bin -v</code> |
| <code>-vv</code> | Maximum verbosity | <code>capa.exe .\cryptbot.bin -vv</code> |
| <code>-j</code> | Output as JSON file | <code>capa -j -vv .\cryptbot.bin > output.json</code> |
...
<ul class="callout-list">
  <li><code>capa.exe .\cryptbot.bin</code></li>
  <li><code>capa.exe .\cryptbot.bin -v > cryptbot_v.txt</code></li>
  <li><code>capa.exe .\cryptbot.bin -vv > cryptbot_vv.txt</code></li>
</ul>
...
<ul class="callout-list">
  <li><code>capa -j -vv .\cryptbot.bin > cryptbot_vv.json</code></li>
</ul>
