...
category: "knowledge"
tags: []
excerpt: "Linux hardening reduces the attack surface of a system through access control, firewall configuration, service..."
date: "2026-06-20"
---
...
| UFW | Simplified iptables front-end — see [Uncomplicated Firewall (UFW)](/tools/Defense-Monitoring/Uncomplicated-Firewall-UFW) |
| FirewallD | Dynamic firewall with zones and services; supports complex configurations |

#### iptables
iptables provides direct rule-based access to Netfilter using tables, chains, targets, and matches for precise packet filtering, NAT, and packet manipulation — see [iptables](/tools/Defense-Monitoring/iptables) for full syntax reference.
...
- [Linux Networking](/knowledge/Operating-Systems/Linux/Linux-Networking)
