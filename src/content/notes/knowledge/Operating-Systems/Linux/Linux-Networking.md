...
category: "knowledge"
tags: []
excerpt: "Linux networking covers interface configuration, access control models, troubleshooting tools, and remote access..."
date: "2026-06-20"
---
...
- **TCP Wrappers** — restrict access to services based on source IP address (see [Linux Hardening](/knowledge/Operating-Systems/Linux/Linux-Hardening))
...
| `tcpdump` | Capture and analyze network traffic — see [TCPDump](/tools/Network-Analysis/TCPDump) |
| `wireshark` | GUI packet analysis — see [Wireshark](/tools/Network-Analysis/Wireshark) |
| `nmap` | Port scanning and service enumeration — see [Nmap](/tools/Enumeration/Nmap) |
...
RDP is Microsoft's remote desktop protocol — primarily used on Windows but accessible from Linux using clients like `xfreerdp` or `remmina`. Provides full graphical desktop interaction. See [Windows Remote Management](/knowledge/Operating-Systems/Windows/Windows-Remote-Management) for footprinting and exploitation context.
...
**Footprinting:** Scan TCP ports 512, 513, and 514 with [Nmap](/tools/Enumeration/Nmap) (`-sV`).
...
- [Linux Hardening](/knowledge/Operating-Systems/Linux/Linux-Hardening)
