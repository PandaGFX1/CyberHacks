...
category: "knowledge"
tags: []
excerpt: "Windows Command Line (CMD) provides core commands and utilities for interacting with the Windows OS, managing..."
date: "2026-06-20"
---
...
| `nslookup <domain>` | Queries DNS for a domain — see [nslookup](/tools/OSINT-Recon/nslookup) |
...
Filter by event ID for targeted investigation — see [Log Fundamentals](/knowledge/Defensive-Security/Log-Fundamentals) for key event IDs to monitor.
