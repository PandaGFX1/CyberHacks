...
category: "knowledge"
tags: []
excerpt: "Windows Fundamentals cover the core components, utilities, file system, user management, and security features of..."
date: "2026-06-20"
---
...
> See [Windows Command Line](/knowledge/Operating-Systems/Windows/Windows-Command-Line) for full `sc` command reference.
...
> See [Windows PowerShell](/knowledge/Operating-Systems/Windows/Windows-PowerShell) for full `Get-WmiObject` and `Get-CimInstance` reference.
> See [Windows Command Line](/knowledge/Operating-Systems/Windows/Windows-Command-Line) for `wmic` CLI commands.
...
| Domain Account | Authenticated by a Domain Controller; credentials stored in Active Directory — see [Active Directory Basics](/knowledge/Operating-Systems/Windows/Active-Directory/Active-Directory-Basics) |
...
#### Firewall
Access via: `WF.msc` or [Windows Defender Firewall](/tools/Defense-Monitoring/Windows-Defender-Firewall)
...
### Common Commands
> Full command reference in [Windows Command Line](/knowledge/Operating-Systems/Windows/Windows-Command-Line)
...
## Related Tools
- [Windows Defender Firewall](/tools/Defense-Monitoring/Windows-Defender-Firewall)
