...
category: "knowledge"
tags: []
excerpt: "Windows PowerShell is an object-oriented scripting language and shell designed for system administration and automation..."
date: "2026-06-20"
---
...
`Get-WinEvent` queries Windows event logs. Use `FilterHashtable` for efficient server-side filtering rather than piping everything through `Where-Object` — FilterHashtable pushes the filter to the log provider, which is significantly faster on large logs. See [Windows Event Logs](/knowledge/Operating-Systems/Windows/Windows-Event-Logs) for Event ID reference and log architecture.
...
See [Log Fundamentals](/knowledge/Defensive-Security/Log-Fundamentals) for key event IDs. Refer to https://www.ultimatewindowssecurity.com/securitylog/encyclopedia/ for the full event ID encyclopedia.
...
WinRM hardening recommendations: restrict `TrustedHosts` to specific IPs, enforce HTTPS transport, and use Kerberos authentication on domain-joined systems. See [Windows Remote Management](/knowledge/Operating-Systems/Windows/Windows-Remote-Management).
...
- [Windows Command Line](/knowledge/Operating-Systems/Windows/Windows-Command-Line)
- [Windows Event Logs](/knowledge/Operating-Systems/Windows/Windows-Event-Logs)
- [Active Directory Basics](/knowledge/Operating-Systems/Windows/Active-Directory/Active-Directory-Basics)
...
## Related Tools
- [Sysmon](/tools/Defense-Monitoring/Sysmon)
