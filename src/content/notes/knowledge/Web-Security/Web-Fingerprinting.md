...
category: "knowledge"
tags: []
excerpt: "Web fingerprinting extracts technical details about the technologies, frameworks, and infrastructure powering a target..."
date: "2026-05-07"
---
...
|------|-------------|----------|
| [Nikto](/tools/Web-Testing/Nikto) | Web server scanner; identifies outdated software, misconfigurations, and dangerous files | Active scan for known vulnerabilities and version fingerprinting |
| [wafw00f](/tools/Web-Testing/wafw00f) | Dedicated WAF detection tool | Identify which WAF is protecting the target before crafting requests |
...
| [Nmap](/tools/Enumeration/Nmap) | NSE scripts can fingerprint web servers and applications | Use with `-sV` and web-specific scripts (e.g., `http-headers`, `http-methods`) |
...
### WAF Detection
WAFs can block or modify reconnaissance requests. Before active scanning, determine if a WAF is present and which product it is. Use [wafw00f](/tools/Web-Testing/wafw00f) for automated detection.
...
---
## Related Concepts
- [Web Reconnaissance](/knowledge/Offensive-Security/Web-Reconnaissance)
- [Web Crawling](/knowledge/Web-Security/Web-Crawling)
...
## Related Tools
- [Nikto](/tools/Web-Testing/Nikto)
- [wafw00f](/tools/Web-Testing/wafw00f)
