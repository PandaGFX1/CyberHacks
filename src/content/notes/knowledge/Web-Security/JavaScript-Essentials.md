...
category: "knowledge"
tags: []
excerpt: "JavaScript (JS) is a scripting language used to add interactivity and dynamic behavior to websites. It runs directly in..."
date: "2026-06-20"
---
...
> These functions can be abused in XSS attacks — see [XSS](/techniques/XSS)
...
## Related Techniques
- [XSS](/techniques/XSS)
- [JavaScript Deobfuscation](/techniques/JavaScript-Deobfuscation)
