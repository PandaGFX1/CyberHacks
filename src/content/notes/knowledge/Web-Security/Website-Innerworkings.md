---
title: "Website Innerworkings"
category: "knowledge"
tags: []
excerpt: "Web applications are dynamic browser-based programs served over HTTP/HTTPS that combine front-end and back-end..."
date: "2026-06-20"
---
...
- See [JavaScript Essentials](/knowledge/Web-Security/JavaScript-Essentials)
...
#### Databases
Web applications use databases to store content, users, and application state. See [SQL Fundamentals](/knowledge/Web-Security/SQL-Fundamentals) for full SQL/NoSQL coverage.
...
CSRF tricks an authenticated user's browser into making a forged request to a web application, performing unintended actions on their behalf. It commonly leverages [XSS](/techniques/XSS) to automatically execute the forged request.
