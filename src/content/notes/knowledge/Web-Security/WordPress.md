...
category: "knowledge"
tags: []
excerpt: "WordPress is an open-source Content Management System (CMS) written in PHP, typically running on an Apache or Nginx web..."
date: "2026-06-20"
---
...
Enumerate and exploit WordPress targets using [WordPress Attacks](/techniques/WordPress-Attacks) and [WPScan](/tools/Web-Testing/WPScan).
