...
category: "knowledge"
tags: []
excerpt: "SNMP (Simple Network Management Protocol) is a protocol for monitoring and managing network devices — routers,..."
date: "2026-06-20"
---
...
Scan UDP/161 with [Nmap](/tools/Enumeration/Nmap) (`-sU`). Multiple SNMP NSE scripts enumerate interfaces, running processes, installed software, network connections, and can brute-force community strings. See [Nmap](/tools/Enumeration/Nmap) for full script reference.
