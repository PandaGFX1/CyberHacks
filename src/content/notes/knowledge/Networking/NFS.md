...
category: "knowledge"
tags: []
excerpt: "NFS (Network File System) is a distributed file system protocol developed by Sun Microsystems that allows file systems..."
date: "2026-06-20"
---
...
### Footprinting NFS
NFS enumeration requires ports 111 and 2049. Scan with [Nmap](/tools/Enumeration/Nmap) using NFS NSE scripts (`--script nfs*`) to list available shares, their contents, and stats.
