...
category: "knowledge"
tags: []
excerpt: "MySQL is an open-source relational database management system (RDBMS) developed by Oracle, using SQL to manage and..."
date: "2026-06-20"
---
...
Scan port 3306 with [Nmap](/tools/Enumeration/Nmap) using the `mysql*` NSE script suite. Some Nmap MySQL script results can produce false positives — manually verify any findings.
