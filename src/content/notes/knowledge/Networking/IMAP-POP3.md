...
category: "knowledge"
tags: []
excerpt: "IMAP (Internet Message Access Protocol) and POP3 (Post Office Protocol 3) are the two primary protocols for retrieving..."
date: "2026-06-20"
---
...
Scan ports 110, 143, 993, and 995 with [Nmap](/tools/Enumeration/Nmap) (`-sV -sC`) — Nmap retrieves TLS/SSL certificate details including CN, organization, and server location.

Connect with [curl](/tools/Utilities/curl) using the IMAPS URL scheme (`curl -k 'imaps://<target>' --user user:pass -v`) to enumerate the server banner and TLS certificate details. See [curl](/tools/Utilities/curl) for full flag reference.
...
## Related Concepts
- [SMTP](/knowledge/Networking/SMTP)
