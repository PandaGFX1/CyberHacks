...
category: "knowledge"
tags: []
excerpt: "SMTP (Simple Mail Transfer Protocol) is the standard protocol for sending email between servers and from email clients..."
date: "2026-06-20"
---
...
Scan ports 25, 465, and 587 with [Nmap](/tools/Enumeration/Nmap) (`-sV -sC`). The `smtp-open-relay` NSE script runs 16 tests specifically to identify open relay configuration. See [Nmap](/tools/Enumeration/Nmap) for full script usage.
...
See [smtp-user-enum](/tools/Enumeration/smtp-user-enum) for the dedicated tool.
...
- [IMAP & POP3](/knowledge/Networking/IMAP-POP3)
...
## Related Tools
- [smtp-user-enum](/tools/Enumeration/smtp-user-enum)
