...
category: "knowledge"
tags: []
excerpt: "MSSQL (Microsoft SQL Server) is Microsoft's enterprise relational database management system. It was originally built..."
date: "2026-06-20"
---
...
Scan port 1433 with [Nmap](/tools/Enumeration/Nmap) using the `ms-sql-*` NSE script suite — covers version info, empty passwords, xp_cmdshell status, NTLM info, table enumeration, and hash dumping. See [Nmap](/tools/Enumeration/Nmap) for full script reference.

Identify MSSQL instances with the `mssql_ping` auxiliary module in [MSFConsole](/tools/Frameworks/Metasploit/MSFConsole).
...
- [SQLMap](/tools/Web-Testing/SQLMap)
