...
category: "knowledge"
tags: []
excerpt: "Hashing transforms plaintext into a fixed-size digest using a one-way function, making it irreversible by design. It is..."
date: "2026-06-20"
---
...
Passwords stored in `/etc/shadow` — see [Linux Fundamentals](/knowledge/Operating-Systems/Linux/Linux-Fundamentals) for file structure detail.
...
- Stored in **SAM (Security Accounts Manager)** — see [Windows Fundamentals](/knowledge/Operating-Systems/Windows/Windows-Fundamentals)
