...
category: "knowledge"
tags: []
excerpt: "Incident Response (IR) is the structured approach organizations use to detect, investigate, and respond to..."
date: "2026-06-20"
---
...
IOCs are added as observables in [TheHive](/tools/Defense-Monitoring/TheHive) and can be searched across the environment using WMI or PowerShell. When connecting to compromised systems to search for IOCs, use only non-caching connection protocols — WinRM or network logons (type 3). PsExec does not cache credentials when used through the current user's session, but will cache them if credentials are passed explicitly.
...
See [Intro to SIEM](/knowledge/Defensive-Security/Security-Solutions/Intro-to-SIEM)

#### Case Management
Centralizes investigation workflow — case tracking, IOC management, MITRE ATT&CK mapping, analyst task assignment.
See [TheHive](/tools/Defense-Monitoring/TheHive)

#### Forensic Tools
Used for disk and memory acquisition and analysis during investigation.
See [Digital Forensics Fundamentals](/knowledge/Defensive-Security/Digital-Forensics-Fundamentals)

#### Network Monitoring
- IDS/IPS for real-time detection — see [Intrusion Detection Systems (IDS)](/knowledge/Defensive-Security/Security-Solutions/Intrusion-Detection-Systems-IDS)
- Packet capture tools for traffic analysis — see [Wireshark](/tools/Network-Analysis/Wireshark), [TCPDump](/tools/Network-Analysis/TCPDump)
...
---
## Related Concepts
- [Defensive Security Intro](/knowledge/Defensive-Security/Defensive-Security-Intro)
...
- [Security Principles](/knowledge/Core-Security-Concepts/Security-Principles)
- [Threat Hunting](/knowledge/Defensive-Security/Threat-Hunting)
- [Cyber Kill Chain](/knowledge/Core-Security-Concepts/Cyber-Kill-Chain)
...
## Related Tools
- [TheHive](/tools/Defense-Monitoring/TheHive)
