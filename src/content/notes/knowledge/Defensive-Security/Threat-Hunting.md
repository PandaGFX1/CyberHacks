...
category: "knowledge"
tags: []
excerpt: "Threat hunting is an active, human-led, hypothesis-driven practice that systematically searches network and endpoint..."
date: "2026-04-17"
---
...
See [Incident Response Fundamentals](/knowledge/Defensive-Security/Incident-Response-Fundamentals) for the full IR lifecycle.
...
3. Comprehend the attack lifecycle — map the described activity to the [Cyber Kill Chain](/knowledge/Core-Security-Concepts/Cyber-Kill-Chain) or [MITRE ATT&CK Framework](/knowledge/Core-Security-Concepts/MITRE-ATTCK-Framework)
...
See [Incident Response Fundamentals](/knowledge/Defensive-Security/Incident-Response-Fundamentals) for the full Pyramid of Pain table.
...
- [SilkETW](/tools/Defense-Monitoring/SilkETW)
