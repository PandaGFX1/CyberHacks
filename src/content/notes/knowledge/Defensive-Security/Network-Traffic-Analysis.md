...
category: "knowledge"
tags: []
excerpt: "Network Traffic Analysis (NTA) is the process of capturing and examining network traffic to characterize port and..."
date: "2026-04-15"
---
...
| Tool | Type | Use Case |
|------|------|----------|
| [TCPDump](/tools/Network-Analysis/TCPDump) | CLI | Headless capture and filtering; scriptable; output to PCAP |
| [Wireshark](/tools/Network-Analysis/Wireshark) | GUI / CLI (TShark) | Deep packet inspection; protocol dissection; GUI-based analysis |
