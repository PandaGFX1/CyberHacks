...
- Export to [TheHive](/tools/Defense-Monitoring/TheHive) observables or MISP events for threat intelligence sharing
...
ATT&CK and the [Cyber Kill Chain](/knowledge/Core-Security-Concepts/Cyber-Kill-Chain) are complementary frameworks:
...
ATT&CK content and IOC intelligence can be shared in STIX format — a structured JSON standard for expressing and exchanging cyber threat intelligence. CISA publishes STIX packages for major incidents. Tools like MISP and [TheHive](/tools/Defense-Monitoring/TheHive) can import and export STIX data natively.
