...
category: "techniques"
tags: []
excerpt: "WordPress attacks follow a natural progression from passive reconnaissance through active enumeration to exploitation...."
date: "2026-06-20"
---
...
- [WPScan](/tools/Web-Testing/WPScan) for automated enumeration and brute-force (optional but recommended)
- [curl](/tools/Utilities/curl) for manual enumeration
...
Response headers may also contain version numbers for specific plugins. Not all installed plugins are visible passively — use [WPScan](/tools/Web-Testing/WPScan) for aggressive enumeration to find hidden ones.
...
See [WPScan](/tools/Web-Testing/WPScan) for full brute-force flag reference.
