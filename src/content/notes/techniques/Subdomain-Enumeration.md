...
category: "techniques"
tags: []
excerpt: "Subdomain enumeration discovers all subdomains associated with a target domain. Development environments, admin panels,..."
date: "2026-05-07"
---
...
2. Run [DNSenum](/tools/Enumeration/DNSenum) for a combined brute force and zone transfer attempt:
   `dnsenum --enum example.com -f /usr/share/seclists/Discovery/DNS/subdomains-top1million-20000.txt -r`
3. Alternatively use [Gobuster](/tools/Enumeration/Gobuster) DNS mode:
