---
title: "HTB CJCA Exam   April 2026"
category: "labs"
tags: []
excerpt: "Note: IP addresses changed multiple times during exam due to network resets."
date: "2026-06-20"
---
...
<summary class="callout-title"><span class="callout-icon">ℹ</span><span>Engagement Details:</span></summary>
...
Full alert-by-alert triage table: [CJCA SIEM Triage](/labs/HackTheBox/Exams/CJCA/CJCA-SIEM-Triage)

---
## Overall Lessons Learned

<details class="callout callout-info">
<summary class="callout-title"><span class="callout-icon">ℹ</span><span>Overall Lessons Learned:</span></summary>
<div class="callout-body">
...
---
## Host Notes
- WEB01 — CVE-2023-3452 LFI → cameron SSH → sudo less escape
- NIX01 — CVE-2023-42793 TeamCity RCE → CVE-2022-0847 DirtyPipe
- NIX02 — marc cred reuse → rbash escape → sudo .email-backup.sh injection
- WIN01 — john cred spray → PS history creds → Administrator RDP
- WIN02 — backup cred spray → MonitorFiles.ps1 injection → Administrator
